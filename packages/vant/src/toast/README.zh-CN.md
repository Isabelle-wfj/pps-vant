...
| iconPrefix | 图标类名前缀，等同于 Icon 组件的 [class-prefix 属性](#/zh-CN/icon#props) | _string_ | `pps-icon` |
...
| --van-toast-text-color | _var(--van-gray-1)_ | - |
| --van-toast-loading-icon-color | _var(--van-gray-1)_ | - |
